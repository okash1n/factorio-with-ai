...
1. 事実確認  
   ...
   実装や方針の状態が変わっているなら、関連する `board/cards/*.md` も確認し、必要なら更新する。
...
4. 本文作成  
   ...
   記事冒頭は毎回「リード文 → 『固定リンク』 → 『今回の進捗』」の順にする。
...
- 記事冒頭の固定構成は「リード文 → 『固定リンク』 → 『今回の進捗』」にする
- リード文は短く、2 から 4 文程度で収める
- リード文では「今回やったこと」と「どこまで到達したか」を先に一段で言う
- 冒頭で経緯説明を長く引っ張らない
- 冒頭で同じ内容を言い換えて繰り返さない
- 『固定リンク』には少なくともリポジトリと記事まとめを入れる
- 『今回の進捗』では、その回で実際に進んだことを短く整理する
